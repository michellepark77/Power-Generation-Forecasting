...
- Feature engineering
- Seq2Seq LSTM neural networks
- Forecast calibration
- Forecast evaluation and diagnostics

The objective is to provide generation forecasts that can support operational planning and energy trading decisions.
